                ...
                case 2: // Select a deck
                    ...
                    if (deckList.size() == 0) {
                        ...
                        do {    // this is a do rather than a while so that when the user selects 5 to return to the main menu, this loop will still run correctly upon returning
                            ...
                            System.out.println("\n1. Show cards in " + selectedDeck.deckName);
                            System.out.println("2. Study " + selectedDeck.deckName + " by question");
                            System.out.println("3. Study " + selectedDeck.deckName + " by answer");
                            System.out.println("4. Shuffle " + selectedDeck.deckName);
                            System.out.println("5. Delete " + selectedDeck.deckName);
                            ...
                            switch (secondSwitchInt) {
                                ...
                                case 4:
                                    //Shuffle Deck
                                    selectedDeck.shuffleDeck();
                                    System.out.println("Your deck has been shuffled");   // Debug purposes
                                    break;
